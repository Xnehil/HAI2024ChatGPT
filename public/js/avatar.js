...
// const modelUrl = "../hiyori/models/Cat/cat2.model3.json";
// const modelUrl = "../hiyori/models/export/meltcat.model3.json";
const modelUrl = "../hiyori/models/idunno/鞋拔子.model3.json";
// const modelUrl = "../hiyori/models/Sacabambaspis/Sacabambaspis.model3.json";

const physicsUrl = "../hiyori/models/idunno/鞋拔子.physics3.json";
...
(async function main() {
  ...
  // load the texture
  let backgroundTexture = PIXI.Texture.from("../images/taverna.jpg");
